...
`,ut={en:{"card.target":"Target","card.current":"Current","card.state":"State","card.hvac_modes":"Mode","card.fan_modes":"Fan","card.swing_modes":"Swing","card.preset_modes":"Preset","card.unavailable":"Unavailable","card.not_found":"Entity not found","card.low":"Low","card.high":"High","mode.off":"Off","mode.heat":"Heat","mode.cool":"Cool","mode.auto":"Auto","mode.dry":"Dry","mode.fan_only":"Fan","mode.heat_cool":"Auto","action.off":"Off","action.heating":"Heating","action.cooling":"Cooling","action.drying":"Drying","action.idle":"Idle","action.fan":"Fan","editor.entity":"Entity","editor.name":"Name (optional)","editor.icon":"Icon (optional)","editor.step_size":"Step size","editor.decimals":"Decimals","editor.popup":"Popup mode","editor.show_header":"Show header"},es:{"card.target":"Objetivo","card.current":"Actual","card.state":"Estado","card.hvac_modes":"Modo","card.fan_modes":"Ventilador","card.swing_modes":"Oscilacion","card.preset_modes":"Preajuste","card.unavailable":"No disponible","card.not_found":"Entidad no encontrada","card.low":"Min","card.high":"Max","mode.off":"Apagado","mode.heat":"Calor","mode.cool":"Frio","mode.auto":"Auto","mode.dry":"Seco","mode.fan_only":"Ventilador","mode.heat_cool":"Auto","action.off":"Apagado","action.heating":"Calentando","action.cooling":"Enfriando","action.drying":"Secando","action.idle":"Inactivo","action.fan":"Ventilando","editor.entity":"Entidad","editor.name":"Nombre (opcional)","editor.icon":"Icono (opcional)","editor.step_size":"Incremento","editor.decimals":"Decimales","editor.popup":"Modo popup","editor.show_header":"Mostrar encabezado"}};function ft(t,e="en"){const i=e.substring(0,2);return ut[i]?.[t]??ut.en?.[t]??t}var mt,gt;!function(t){t.OFF="off",t.HEAT="heat",t.COOL="cool",t.HEAT_COOL="heat_cool",t.AUTO="auto",t.DRY="dry",t.FAN_ONLY="fan_only"}(mt||(mt={})),function(t){t.OFF="off",t.HEATING="heating",t.COOLING="cooling",t.DRYING="drying",t.IDLE="idle",t.FAN="fan"}(gt||(gt={}));const _t={[mt.HEAT]:"#ff8100",[mt.COOL]:"#2b9af9",[mt.AUTO]:"#4caf50",[mt.HEAT_COOL]:"#4caf50",[mt.DRY]:"#efbd07",[mt.FAN_ONLY]:"#8a8a8a",[mt.OFF]:"#8a8a8a"};function vt(t,e){return e?.[t]??_t[t]??"#8a8a8a"}function $t(t){const e=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(t);return e?`${parseInt(e[1],16)}, ${parseInt(e[2],16)}, ${parseInt(e[3],16)}`:"138, 138, 138"}gt.HEATING,gt.COOLING,gt.DRYING,gt.IDLE,gt.FAN,gt.OFF;const yt={[mt.OFF]:"mdi:power",[mt.HEAT]:"mdi:fire",[mt.COOL]:"mdi:snowflake",[mt.HEAT_COOL]:"mdi:autorenew",[mt.AUTO]:"mdi:autorenew",[mt.DRY]:"mdi:water-percent",[mt.FAN_ONLY]:"mdi:fan"};gt.HEATING,gt.COOLING,gt.DRYING,gt.IDLE,gt.FAN,gt.OFF;const bt={auto:"mdi:fan-auto",low:"mdi:fan-speed-1",medium:"mdi:fan-speed-2","medium-low":"mdi:fan-speed-1","medium-high":"mdi:fan-speed-2",high:"mdi:fan-speed-3",on:"mdi:fan",off:"mdi:fan-off",diffuse:"mdi:weather-windy"},xt={on:"mdi:arrow-oscillating",off:"mdi:arrow-oscillating-off",both:"mdi:arrow-oscillating",vertical:"mdi:arrow-up-down",horizontal:"mdi:arrow-left-right"},wt={none:"mdi:cancel",home:"mdi:home",away:"mdi:account-arrow-right",boost:"mdi:rocket-launch",comfort:"mdi:sofa",eco:"mdi:leaf",sleep:"mdi:bed",activity:"mdi:motion-sensor"};function At(t){return yt[t]??"mdi:thermostat"}function Ct(t,e=1,i="N/A"){return null==t||isNaN(t)?i:Number(t).toFixed(e)}function Et(t,e,i,o){const s=new CustomEvent(e,{bubbles:!0,composed:!0,cancelable:!1,detail:i});t.dispatchEvent(s)}function St(t,e="light"){Et(t,"haptic",e)}function Ot(t,e){Et(t,"hass-more-info",{entityId:e})}const Tt={hvac:{type:"hvac",attributeModes:"hvac_modes",attributeActive:"__state__",headingKey:"card.hvac_modes",getIcon:At,getColor:vt},fan:{type:"fan",attributeModes:"fan_modes",attributeActive:"fan_mode",headingKey:"card.fan_modes",getIcon:function(t){return bt[t.toLowerCase()]??"mdi:fan"},getColor:()=>"#8a8a8a"},preset:{type:"preset",attributeModes:"preset_modes",attributeActive:"preset_mode",headingKey:"card.preset_modes",getIcon:function(t){return wt[t.toLowerCase()]??"mdi:tune"},getColor:()=>"#8a8a8a"},swing:{type:"swing",attributeModes:"swing_modes",attributeActive:"swing_mode",headingKey:"card.swing_modes",getIcon:function(t){return xt[t.toLowerCase()]??"mdi:arrow-oscillating"},getColor:()=>"#8a8a8a"}},Pt=["off","heat","cool","heat_cool","auto","dry","fan_only"];function Nt(t,e,i,o,s){if(!1===o)return Y;const n=t.language??"en",r=i.layout?.mode??{},a=!1!==r.names,c=!1!==r.icons,d=!0===r.headings,l=[];for(const r of["hvac","fan","preset","swing"]){const h=o[r];if(!1===h||void 0===h)continue;const p=Mt(t,e,i,Tt[r],h,n,a,c,d,t=>s(r,t));p!==Y&&l.push(p)}return 0===l.length?Y:V`${l}`}function Mt(t,e,i,o,s,n,r,a,c,d){const l=e.attributes[o.attributeModes]??[];if(0===l.length)return Y;if(("object"==typeof s&&void 0!==s._hide_when_off?s._hide_when_off:"hvac"!==o.type)&&("off"===e.state||"unavailable"===e.state))return Y;const h="__state__"===o.attributeActive?e.state:e.attributes[o.attributeActive]??"",p="object"==typeof s&&s._name?s._name:ft(o.headingKey,n);let u=[...l];"hvac"===o.type&&u.sort((t,e)=>(-1!==Pt.indexOf(t)?Pt.indexOf(t):99)-(-1!==Pt.indexOf(e)?Pt.indexOf(e):99));const f=[];for(const t of u){let e;if("object"==typeof s){const i=s[t];if(!1===i||"object"==typeof i&&!1===i?.include)continue;"object"==typeof i&&(e=i)}const r=void 0!==e?.name&&!1!==e.name?e.name:ft(`mode.${t}`,n)!==`mode.${t}`?ft(`mode.${t}`,n):t.replace(/_/g," "),a=void 0!==e?.icon&&!1!==e.icon?e.icon:o.getIcon(t),c=o.getColor(t,i.colors);f.push({value:t,name:r,icon:a,color:c})}return 0===f.length?Y:V`
  ...
  `}class Ut extends at{constructor(){super(...arguments),this._expanded=!1,this._pendingValues={},this._longPressFired=!1,this._debouncedCallService=function(t,e){let i;const o=(...o)=>{void 0!==i&&clearTimeout(i),i=setTimeout(()=>{i=void 0,t(...o)},e)};return o.cancel=()=>{void 0!==i&&(clearTimeout(i),i=void 0)},o}(t=>{const e=this._config.service,i=e?.domain??"climate",o=e?.service??"set_temperature";this._hass.callService(i,o,{entity_id:this._config.entity,...t,...e?.data??{}}).then(()=>{this._pendingValues={}}).catch(()=>{this._pendingValues={}})},500),this._normalizedControl="auto",this._onPointerDown=()=>{this._longPressFired=!1,this._longPressTimer=setTimeout(()=>{this._longPressFired=!0,Ot(this,this._config.entity),St(this,"light")},500)},this._onPointerUp=()=>{clearTimeout(this._longPressTimer),this._longPressFired||this._config.popup&&(this._expanded?this._collapse():this._expand())},this._onPointerCancel=()=>{clearTimeout(this._longPressTimer)}}static get styles(){return pt}static getConfigElement(){return document.createElement("dira-thermostat-editor")}static getStubConfig(){return{entity:""}}set hass(t){this._hass=t}get hass(){return this._hass}setConfig(t){if(!t.entity)throw new Error("You must define an entity");this._normalizedControl=this._normalizeControl(t.control),this._config=t}getCardSize(){return this._config?.popup?2:4}_normalizeControl(t){if(!1===t)return!1;if(null==t)return"auto";if(Array.isArray(t)){const e={};return t.forEach(t=>{e[t]=!0}),e}return t}_getEffectiveControl(t){const e=this._normalizedControl;if(!1===e)return!1;if("auto"===e){const e={hvac:!0};return t.attributes.fan_modes?.length>0&&(e.fan=!0),t.attributes.preset_modes?.length>0&&(e.preset=!0),t.attributes.swing_modes?.length>0&&(e.swing=!0),e}return e}_getTemperatureCallbacks(){const t=this._hass.states[this._config.entity];if(!t)return{onIncrement:()=>{},onDecrement:()=>{}};const e=this._config.step_size??t.attributes.target_temp_step??.5;return{onIncrement:i=>{const o=this._pendingValues[i]??t.attributes[i];if(void 0===o)return;const s=Math.round(10*(Number(o)+e))/10;this._setPendingTemperature(i,s,t)},onDecrement:i=>{const o=this._pendingValues[i]??t.attributes[i];if(void 0===o)return;const s=Math.round(10*(Number(o)-e))/10;this._setPendingTemperature(i,s,t)}}}_setPendingTemperature(t,e,i){const o=i.attributes.min_temp??7,s=i.attributes.max_temp??35,n=Math.max(o,Math.min(s,e));if(this._pendingValues={...this._pendingValues,[t]:n},function(t){const e=t.attributes;return"number"==typeof e.target_temp_low&&"number"==typeof e.target_temp_high}(i)){const t={target_temp_low:this._pendingValues.target_temp_low??i.attributes.target_temp_low,target_temp_high:this._pendingValues.target_temp_high??i.attributes.target_temp_high};this._debouncedCallService(t)}else this._debouncedCallService({[t]:n});St(this,"light"),this._resetCollapseTimer()}_expand(){this._expanded=!0,this._resetCollapseTimer()}_collapse(){this._expanded=!1,this._clearCollapseTimer()}_resetCollapseTimer(){this._clearCollapseTimer(),this._collapseTimer=setTimeout(()=>{this._expanded=!1},1e4)}_clearCollapseTimer(){void 0!==this._collapseTimer&&(clearTimeout(this._collapseTimer),this._collapseTimer=void 0)}disconnectedCallback(){super.disconnectedCallback(),this._clearCollapseTimer(),clearTimeout(this._longPressTimer)}_onModeSelect(t,e){this._resetCollapseTimer();const[i,o,s]={hvac:["climate","set_hvac_mode","hvac_mode"],fan:["climate","set_fan_mode","fan_mode"],preset:["climate","set_preset_mode","preset_mode"],swing:["climate","set_swing_mode","swing_mode"]}[t];this._hass.callService(i,o,{entity_id:this._config.entity,[s]:e}).then(()=>St(this,"light")).catch(()=>St(this,"failure"))}render(){if(!this._hass||!this._config)return Y;const t=this._hass.states[this._config.entity];if(!t)return V`
        ...
        <ha-card>
          ...
          ${this._expanded?V`
                <div class="expand-section">
                  ${Nt(this._hass,t,this._config,e,(t,e)=>this._onModeSelect(t,e))}
                  ${!0!==this._config.hide?.state?kt(this,this._hass,t,this._config):Y}
                </div>
              `:Y}
        </ha-card>
      `}const e=this._getEffectiveControl(t);return V`
      <ha-card>
        ${!1!==this._config.header?this._renderCompact(t):Y}
        ${Nt(this._hass,t,this._config,e,(t,e)=>this._onModeSelect(t,e))}
        ${!0!==this._config.hide?.state?kt(this,this._hass,t,this._config):Y}
      </ha-card>
    `}_renderCompact(t){const e=function(t,e){return e||(t.attributes.friendly_name??t.entity_id)}(t,this._config.name),i=t.state,o=this._hass.language??"en",s=vt(i,this._config.colors),n=$t(s),r="off"===i||"unavailable"===i,a=r||"fan_only"===i||!0===this._config.hide?.temperature,c=this._config.icon??At(i),d=ft(`mode.${i}`,o),l=t.attributes.fan_mode;let h=d;this._config.show_fan_speed&&l&&!r&&(h=`${d} · ${l}`);const p=t.attributes.current_temperature,u=t.attributes.current_humidity,f=function(t,e){return!1===e?"":"string"==typeof e?e:t.attributes.unit_of_measurement??"°C"}(t,this._config.unit),m=this._config.decimals??1,g=[];null!=p&&g.push(`${Ct(p,m)} ${f}`),null!=u&&g.push(`${Math.round(u)}%`);const _=this._pendingValues.temperature??t.attributes.temperature,v=void 0!==this._pendingValues.temperature,$=t.attributes.min_temp??7,y=t.attributes.max_temp??35,b=this._getTemperatureCallbacks(),x=r?"":`background-color: rgba(${n}, 0.2)`,w=r?"":`color: ${s}`;return V`
      <div class="compact">
        <div
          class="compact-left"
        ...
        >
          <div class="icon-shape" style="${x}">
            <ha-icon .icon=${c} style="${w}"></ha-icon>
          </div>
          <div class="info">
            <div class="name">${e}</div>
            <div class="secondary">
              ${h}
              ${g.length>0?V` <span class="stats">\u00b7 ${g.join(" · ")}</span>`:Y}
            </div>
          </div>
        </div>
        ${a||void 0===_?Y:V`
    ...
    `}updated(t){if(super.updated(t),t.has("_hass")&&Object.keys(this._pendingValues).length>0){const e=t.get("_hass");if(e){const t=e.states[this._config.entity],i=this._hass.states[this._config.entity];t&&i&&t.attributes.temperature!==i.attributes.temperature&&(this._pendingValues={})}}}}t([ht()],Ut.prototype,"_hass",void 0),t([ht()],Ut.prototype,"_config",void 0),t([ht()],Ut.prototype,"_expanded",void 0),t([ht()],Ut.prototype,"_pendingValues",void 0);class zt extends at{set hass(t){this._hass=t}setConfig(t){this._config={...t}}get _lang(){return this._hass?.language??"en"}_updateConfig(t){this._config={...this._config,...t},Et(this,"config-changed",{config:this._config})}render(){return this._hass&&this._config?V`
      <div class="editor">
        <ha-entity-picker
          .hass=${this._hass}
