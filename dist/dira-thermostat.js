        ...
        <ha-card>
          ...
          ${this._expanded?F`
                <div class="expand-section">
                  ...
                  ${Ut(this._hass,t,this._config,e,(t,e)=>this._onModeSelect(t,e))}
      ...
      <div class="compact">
        ...
        >
          <div class="icon-shape" style="${r?"":`background-color: rgba(${n}, 0.2)`}">
            <ha-icon .icon=${a} style="${r?"":`color: ${o}`}"></ha-icon>
          </div>
          <div class="info">
