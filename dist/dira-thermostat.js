...
`,ut={en:{"card.target":"Target","card.current":"Current","card.state":"State","card.hvac_modes":"Mode","card.fan_modes":"Fan","card.swing_modes":"Swing","card.preset_modes":"Preset","card.unavailable":"Unavailable","card.not_found":"Entity not found","card.low":"Low","card.high":"High","mode.off":"Off","mode.heat":"Heat","mode.cool":"Cool","mode.auto":"Auto","mode.dry":"Dry","mode.fan_only":"Fan","mode.heat_cool":"Auto","action.off":"Off","action.heating":"Heating","action.cooling":"Cooling","action.drying":"Drying","action.idle":"Idle","action.fan":"Fan","editor.entity":"Entity","editor.name":"Name (optional)","editor.icon":"Icon (optional)","editor.step_size":"Step size","editor.decimals":"Decimals","editor.popup":"Popup mode","editor.show_header":"Show header"},es:{"card.target":"Objetivo","card.current":"Actual","card.state":"Estado","card.hvac_modes":"Modo","card.fan_modes":"Ventilador","card.swing_modes":"Oscilacion","card.preset_modes":"Preajuste","card.unavailable":"No disponible","card.not_found":"Entidad no encontrada","card.low":"Min","card.high":"Max","mode.off":"Apagado","mode.heat":"Calor","mode.cool":"Frio","mode.auto":"Auto","mode.dry":"Seco","mode.fan_only":"Ventilador","mode.heat_cool":"Auto","action.off":"Apagado","action.heating":"Calentando","action.cooling":"Enfriando","action.drying":"Secando","action.idle":"Inactivo","action.fan":"Ventilando","editor.entity":"Entidad","editor.name":"Nombre (opcional)","editor.icon":"Icono (opcional)","editor.step_size":"Incremento","editor.decimals":"Decimales","editor.popup":"Modo popup","editor.show_header":"Mostrar encabezado"}};function ft(t,e="en"){const i=e.substring(0,2);return ut[i]?.[t]??ut.en?.[t]??t}var mt,gt;!function(t){t.OFF="off",t.HEAT="heat",t.COOL="cool",t.HEAT_COOL="heat_cool",t.AUTO="auto",t.DRY="dry",t.FAN_ONLY="fan_only"}(mt||(mt={})),function(t){t.OFF="off",t.HEATING="heating",t.COOLING="cooling",t.DRYING="drying",t.IDLE="idle",t.FAN="fan"}(gt||(gt={}));const _t={[mt.HEAT]:"#ff8100",[mt.COOL]:"#2b9af9",[mt.AUTO]:"#4caf50",[mt.HEAT_COOL]:"#4caf50",[mt.DRY]:"#efbd07",[mt.FAN_ONLY]:"#8a8a8a",[mt.OFF]:"#8a8a8a"};function $t(t,e){return e?.[t]??_t[t]??"#8a8a8a"}function vt(t){const e=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(t);return e?`${parseInt(e[1],16)}, ${parseInt(e[2],16)}, ${parseInt(e[3],16)}`:"138, 138, 138"}gt.HEATING,gt.COOLING,gt.DRYING,gt.IDLE,gt.FAN,gt.OFF;const bt={[mt.OFF]:"mdi:power",[mt.HEAT]:"mdi:fire",[mt.COOL]:"mdi:snowflake",[mt.HEAT_COOL]:"mdi:autorenew",[mt.AUTO]:"mdi:autorenew",[mt.DRY]:"mdi:water-percent",[mt.FAN_ONLY]:"mdi:fan"};gt.HEATING,gt.COOLING,gt.DRYING,gt.IDLE,gt.FAN,gt.OFF;const yt={auto:"mdi:fan-auto",low:"mdi:fan-speed-1",medium:"mdi:fan-speed-2","medium-low":"mdi:fan-speed-1","medium-high":"mdi:fan-speed-2",high:"mdi:fan-speed-3",on:"mdi:fan",off:"mdi:fan-off",diffuse:"mdi:weather-windy"},xt={on:"mdi:arrow-oscillating",off:"mdi:arrow-oscillating-off",both:"mdi:arrow-oscillating",vertical:"mdi:arrow-up-down",horizontal:"mdi:arrow-left-right"},wt={none:"mdi:cancel",home:"mdi:home",away:"mdi:account-arrow-right",boost:"mdi:rocket-launch",comfort:"mdi:sofa",eco:"mdi:leaf",sleep:"mdi:bed",activity:"mdi:motion-sensor"};function At(t){return bt[t]??"mdi:thermostat"}function Ct(t){const e=t.attributes;return"number"==typeof e.target_temp_low&&"number"==typeof e.target_temp_high}function Et(t,e=1,i="N/A"){return null==t||isNaN(t)?i:Number(t).toFixed(e)}function St(t,e){return!1===e?"":"string"==typeof e?e:t.attributes.unit_of_measurement??"°C"}function Ot(t,e){return e||(t.attributes.friendly_name??t.entity_id)}function kt(t,e,i,s){const n=new CustomEvent(e,{bubbles:!0,composed:!0,cancelable:!1,detail:i});t.dispatchEvent(n)}function Tt(t,e="light"){kt(t,"haptic",e)}function Pt(t,e){kt(t,"hass-more-info",{entityId:e})}function Nt(t,e,i,s){if(!1===s.header)return Y;const n="object"==typeof s.header?s.header:{};if(!1===n.name&&!1===n.icon)return Y;const o=e.language??"en",r=Ot(i,s.name),a=i.state,c=$t(a,s.colors),d=vt(c),l="off"===a||"unavailable"===a,h=s.icon??n.icon??At(a),p=ft(`mode.${a}`,o),u=i.attributes.hvac_action,f=u?ft(`action.${u}`,o):"";let m=p;s.show_action&&f&&"off"!==u&&(m=`${p} · ${f}`);const g=i.attributes.fan_mode;s.show_fan_speed&&g&&!l&&(m=`${m} · ${g}`);const _=i.attributes.current_temperature,$=i.attributes.current_humidity,v=i.attributes.unit_of_measurement??"°C",b=[];null!=_&&b.push(`${Et(_,s.decimals??1)} ${v}`),null!=$&&b.push(`${Math.round($)}%`);return F`
    ...
    >
      ${!1!==h?F`
          ...
          `:Y}
      <div class="info">
        ${!1!==n.name?F`<div class="name">${r}</div>`:Y}
        <div class="secondary">
          ${m}
      ...
      <div class="header-actions">
        ${function(t,e,i){if(!i||0===i.length)return Y;const s=i.map(i=>{const s=e.states[i.entity];if(!s)return Y;const n="on"===s.state;if(!n&&i.hide_inactive)return Y;const o=i.icon??s.attributes.icon??"mdi:alert-circle";return F`
        <ha-icon
          class="fault-icon ${n?"active":"inactive"}"
          .icon=${o}
          @click=${e=>{e.stopPropagation(),Pt(t,i.entity)}}
        ></ha-icon>
      `}).filter(t=>t!==Y);return 0===s.length?Y:F`${s}`}(t,e,n.faults)}
        ${function(t,e,i){if(!i?.entity)return Y;const s=e.states[i.entity];if(!s)return Y;const n="on"===s.state;return F`
    <ha-switch
      .checked=${n}
      @change=${t=>{t.stopPropagation(),e.callService("homeassistant",n?"turn_off":"turn_on",{entity_id:i.entity})}}
    ></ha-switch>
  `}(0,e,n.toggle)}
      </div>
    </div>
  `}function Mt(t,e,i,s,n,o){if(!1===s.setpoints)return Y;const r=i.attributes,a=s.decimals??1,c=s.fallback??"N/A",d=St(i,s.unit),l=r.min_temp??7,h=r.max_temp??35;return Ct(i)?function(t,e,i,s,n,o,r,a,c,d,l){const h=e.language??"en";s.step_size??i.attributes.target_temp_step;const p=[{key:"target_temp_low",label:ft("card.low",h),rawValue:i.attributes.target_temp_low},{key:"target_temp_high",label:ft("card.high",h),rawValue:i.attributes.target_temp_high}],u=p.filter(t=>!s.setpoints||"object"!=typeof s.setpoints||!s.setpoints[t.key]?.hide).map(e=>{const s=n[e.key]??e.rawValue,h=void 0!==n[e.key];return F`
      ...
      `});return F`<div class="dual-setpoints">${u}</div>`}(t,e,i,s,n,o,a,c,d,l,h):function(t,e,i,s,n,o,r,a,c,d){const l=e.attributes.temperature,h=s.temperature??l,p=void 0!==s.temperature;if(i.step_size??e.attributes.target_temp_step,i.setpoints&&"object"==typeof i.setpoints&&i.setpoints.temperature?.hide)return F``;return F`
    <div class="temperature-control">
      <button
        class="temp-button"
        @click=${()=>n.onDecrement("temperature")}
      ...
      <button
        class="temp-button"
        @click=${()=>n.onIncrement("temperature")}
        ?disabled=${void 0!==h&&h>=d}
      >
        <ha-icon .icon=${"mdi:plus"}></ha-icon>
      </button>
    </div>
  `}(t,i,s,n,o,a,c,d,l,h)}const zt={hvac:{type:"hvac",attributeModes:"hvac_modes",attributeActive:"__state__",headingKey:"card.hvac_modes",getIcon:At,getColor:$t},fan:{type:"fan",attributeModes:"fan_modes",attributeActive:"fan_mode",headingKey:"card.fan_modes",getIcon:function(t){return yt[t.toLowerCase()]??"mdi:fan"},getColor:()=>"#8a8a8a"},preset:{type:"preset",attributeModes:"preset_modes",attributeActive:"preset_mode",headingKey:"card.preset_modes",getIcon:function(t){return wt[t.toLowerCase()]??"mdi:tune"},getColor:()=>"#8a8a8a"},swing:{type:"swing",attributeModes:"swing_modes",attributeActive:"swing_mode",headingKey:"card.swing_modes",getIcon:function(t){return xt[t.toLowerCase()]??"mdi:arrow-oscillating"},getColor:()=>"#8a8a8a"}},Ut=["off","heat","cool","heat_cool","auto","dry","fan_only"];function Ht(t,e,i,s,n){if(!1===s)return Y;const o=t.language??"en",r=i.layout?.mode??{},a=!1!==r.names,c=!1!==r.icons,d=!0===r.headings,l=[];for(const r of["hvac","fan","preset","swing"]){const h=s[r];if(!1===h||void 0===h)continue;const p=It(t,e,i,zt[r],h,o,a,c,d,t=>n(r,t));p!==Y&&l.push(p)}return 0===l.length?Y:F`${l}`}function It(t,e,i,s,n,o,r,a,c,d){const l=e.attributes[s.attributeModes]??[];if(0===l.length)return Y;if("object"==typeof n&&n._hide_when_off&&"off"===e.state)return Y;const h="__state__"===s.attributeActive?e.state:e.attributes[s.attributeActive]??"",p="object"==typeof n&&n._name?n._name:ft(s.headingKey,o);let u=[...l];"hvac"===s.type&&u.sort((t,e)=>(-1!==Ut.indexOf(t)?Ut.indexOf(t):99)-(-1!==Ut.indexOf(e)?Ut.indexOf(e):99));const f=[];for(const t of u){let e;if("object"==typeof n){const i=n[t];if(!1===i||"object"==typeof i&&!1===i?.include)continue;"object"==typeof i&&(e=i)}const r=void 0!==e?.name&&!1!==e.name?e.name:ft(`mode.${t}`,o)!==`mode.${t}`?ft(`mode.${t}`,o):t.replace(/_/g," "),a=void 0!==e?.icon&&!1!==e.icon?e.icon:s.getIcon(t),c=s.getColor(t,i.colors);f.push({value:t,name:r,icon:a,color:c})}return 0===f.length?Y:F`
  ...
  `}function Dt(t,e,i,s){if(!1===s.sensors||!s.sensors||0===s.sensors.length)return Y;const n=s.layout?.sensors??{},o="table"===n.type,r=!1!==n.labels,a=s.sensors.map(s=>function(t,e,i,s,n){const o=s.entity??i.entity_id,r=e.states[o];if(!r)return Y;let a,c;if(s.attribute)a=r.attributes[s.attribute];else{if(!s.entity)return Y;a=r.state}if(null==a)return Y;if("relativetime"===s.type){c=function(t){const e=Date.now(),i=Math.floor((e-t.getTime())/1e3);return i<60?`${i}s`:i<3600?`${Math.floor(i/60)}m`:i<86400?`${Math.floor(i/3600)}h`:`${Math.floor(i/86400)}d`}(new Date(a))}else c=void 0!==s.decimals&&"number"==typeof a?Et(a,s.decimals):String(a);const d=s.unit??(s.attribute?"":r.attributes.unit_of_measurement??""),l=s.name??(s.attribute?s.attribute.replace(/_/g," "):r.attributes.friendly_name??o);return F`
    <div
      class="sensor-item"
      @click=${()=>Pt(t,o)}
    >
      ${s.icon?F`<ha-icon .icon=${s.icon}></ha-icon>`:Y}
      ${n&&!s.icon?F`<span class="sensor-label">${l}:</span>`:Y}
  ...
  `}class Rt extends at{constructor(){super(...arguments),this._expanded=!1,this._pendingValues={},this._debouncedCallService=function(t,e){let i;const s=(...s)=>{void 0!==i&&clearTimeout(i),i=setTimeout(()=>{i=void 0,t(...s)},e)};return s.cancel=()=>{void 0!==i&&(clearTimeout(i),i=void 0)},s}(t=>{const e=this._config.service,i=e?.domain??"climate",s=e?.service??"set_temperature";this._hass.callService(i,s,{entity_id:this._config.entity,...t,...e?.data??{}}).then(()=>{this._pendingValues={}}).catch(()=>{this._pendingValues={}})},500),this._normalizedControl="auto"}static get styles(){return pt}static getConfigElement(){return document.createElement("dira-thermostat-editor")}static getStubConfig(){return{entity:""}}set hass(t){this._hass=t}get hass(){return this._hass}setConfig(t){if(!t.entity)throw new Error("You must define an entity");this._normalizedControl=this._normalizeControl(t.control),this._config=t}getCardSize(){return this._config?.popup?2:4}_normalizeControl(t){if(!1===t)return!1;if(null==t)return"auto";if(Array.isArray(t)){const e={};return t.forEach(t=>{e[t]=!0}),e}return t}_getEffectiveControl(t){const e=this._normalizedControl;if(!1===e)return!1;if("auto"===e){const e={hvac:!0};return t.attributes.fan_modes?.length>0&&(e.fan=!0),t.attributes.preset_modes?.length>0&&(e.preset=!0),t.attributes.swing_modes?.length>0&&(e.swing=!0),e}return e}_getTemperatureCallbacks(){const t=this._hass.states[this._config.entity];if(!t)return{onIncrement:()=>{},onDecrement:()=>{}};const e=this._config.step_size??t.attributes.target_temp_step??.5;return{onIncrement:i=>{const s=this._pendingValues[i]??t.attributes[i];if(void 0===s)return;const n=Math.round(10*(Number(s)+e))/10;this._setPendingTemperature(i,n,t)},onDecrement:i=>{const s=this._pendingValues[i]??t.attributes[i];if(void 0===s)return;const n=Math.round(10*(Number(s)-e))/10;this._setPendingTemperature(i,n,t)}}}_setPendingTemperature(t,e,i){const s=i.attributes.min_temp??7,n=i.attributes.max_temp??35,o=Math.max(s,Math.min(n,e));if(this._pendingValues={...this._pendingValues,[t]:o},Ct(i)){const t={target_temp_low:this._pendingValues.target_temp_low??i.attributes.target_temp_low,target_temp_high:this._pendingValues.target_temp_high??i.attributes.target_temp_high};this._debouncedCallService(t)}else this._debouncedCallService({[t]:o});Tt(this,"light"),this._resetCollapseTimer()}_expand(){this._expanded=!0,this._resetCollapseTimer()}_collapse(){this._expanded=!1,this._clearCollapseTimer()}_resetCollapseTimer(){this._clearCollapseTimer(),this._collapseTimer=setTimeout(()=>{this._expanded=!1},1e4)}_clearCollapseTimer(){void 0!==this._collapseTimer&&(clearTimeout(this._collapseTimer),this._collapseTimer=void 0)}disconnectedCallback(){super.disconnectedCallback(),this._clearCollapseTimer()}_onModeSelect(t,e){this._resetCollapseTimer();const[i,s,n]={hvac:["climate","set_hvac_mode","hvac_mode"],fan:["climate","set_fan_mode","fan_mode"],preset:["climate","set_preset_mode","preset_mode"],swing:["climate","set_swing_mode","swing_mode"]}[t];this._hass.callService(i,s,{entity_id:this._config.entity,[n]:e}).then(()=>Tt(this,"light")).catch(()=>Tt(this,"failure"))}render(){if(!this._hass||!this._config)return Y;const t=this._hass.states[this._config.entity];if(!t)return F`
        ...
        <ha-card>
          ...
          ${this._expanded?F`
                <div class="expand-section">
                  ${!0!==this._config.hide?.temperature?Mt(this,this._hass,t,this._config,this._pendingValues,this._getTemperatureCallbacks()):Y}
    ...
    `}_renderCompact(t){const e=Ot(t,this._config.name),i=t.state,s=this._hass.language??"en",n=$t(i,this._config.colors),o=vt(n),r="off"===i||"unavailable"===i,a=this._config.icon??At(i),c=ft(`mode.${i}`,s),d=t.attributes.fan_mode;let l=c;this._config.show_fan_speed&&d&&!r&&(l=`${c} · ${d}`);const h=t.attributes.current_temperature,p=t.attributes.current_humidity,u=St(t,this._config.unit),f=this._config.decimals??1,m=[];null!=h&&m.push(`${Et(h,f)} ${u}`),null!=p&&m.push(`${Math.round(p)}%`);const g=this._pendingValues.temperature??t.attributes.temperature,_=void 0!==this._pendingValues.temperature,$=t.attributes.min_temp??7,v=t.attributes.max_temp??35,b=this._getTemperatureCallbacks();return F`
      <div class="compact">
        <div
          class="compact-left"
          @click=${()=>this._expand()}
        >
          <div class="icon-shape" style="${r?"":`background-color: rgba(${o}, 0.2)`}">
            <ha-icon .icon=${a} style="${r?"":`color: ${n}`}"></ha-icon>
          </div>
          <div class="info">
