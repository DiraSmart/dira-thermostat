...
`,ut={en:{"card.target":"Target","card.current":"Current","card.state":"State","card.hvac_modes":"Mode","card.fan_modes":"Fan","card.swing_modes":"Swing","card.preset_modes":"Preset","card.unavailable":"Unavailable","card.not_found":"Entity not found","card.low":"Low","card.high":"High","mode.off":"Off","mode.heat":"Heat","mode.cool":"Cool","mode.auto":"Auto","mode.dry":"Dry","mode.fan_only":"Fan","mode.heat_cool":"Auto","mode.unavailable":"Unavailable","action.off":"Off","action.heating":"Heating","action.cooling":"Cooling","action.drying":"Drying","action.idle":"Idle","action.fan":"Fan","editor.entity":"Entity","editor.name":"Name (optional)","editor.icon":"Icon (optional)","editor.step_size":"Step size","editor.min_temp":"Min temperature (optional)","editor.max_temp":"Max temperature (optional)","editor.decimals":"Decimals","editor.compact":"Compact mode (expand on click)","editor.show_header":"Show header","editor.show_fan":"Show fan mode","editor.show_fan_icons":"Show fan mode icons","editor.show_preset":"Show preset mode","editor.show_swing":"Show swing mode","editor.show_fan_speed":"Show fan speed in header","editor.show_action":"Show current action","editor.hide_temp":"Hide temperature","editor.hide_state":"Hide sensors","editor.toggle_entity":"Toggle entity (optional)"},es:{"card.target":"Objetivo","card.current":"Actual","card.state":"Estado","card.hvac_modes":"Modo","card.fan_modes":"Ventilador","card.swing_modes":"Oscilacion","card.preset_modes":"Preajuste","card.unavailable":"No disponible","card.not_found":"Entidad no encontrada","card.low":"Min","card.high":"Max","mode.off":"Apagado","mode.heat":"Calor","mode.cool":"Frio","mode.auto":"Auto","mode.dry":"Seco","mode.fan_only":"Ventilador","mode.heat_cool":"Auto","mode.unavailable":"No disponible","action.off":"Apagado","action.heating":"Calentando","action.cooling":"Enfriando","action.drying":"Secando","action.idle":"Inactivo","action.fan":"Ventilando","editor.entity":"Entidad","editor.name":"Nombre (opcional)","editor.icon":"Icono (opcional)","editor.step_size":"Incremento","editor.min_temp":"Temperatura minima (opcional)","editor.max_temp":"Temperatura maxima (opcional)","editor.decimals":"Decimales","editor.compact":"Modo compacto (expandir al tocar)","editor.show_header":"Mostrar encabezado","editor.show_fan":"Mostrar modo ventilador","editor.show_fan_icons":"Mostrar iconos del ventilador","editor.show_preset":"Mostrar preajuste","editor.show_swing":"Mostrar oscilacion","editor.show_fan_speed":"Mostrar velocidad en encabezado","editor.show_action":"Mostrar accion actual","editor.hide_temp":"Ocultar temperatura","editor.hide_state":"Ocultar sensores","editor.toggle_entity":"Entidad toggle (opcional)"}};function ft(t,e="en"){const i=e.substring(0,2);return ut[i]?.[t]??ut.en?.[t]??t}var gt,mt;!function(t){t.OFF="off",t.HEAT="heat",t.COOL="cool",t.HEAT_COOL="heat_cool",t.AUTO="auto",t.DRY="dry",t.FAN_ONLY="fan_only"}(gt||(gt={})),function(t){t.OFF="off",t.HEATING="heating",t.COOLING="cooling",t.DRYING="drying",t.IDLE="idle",t.FAN="fan"}(mt||(mt={}));const _t={[gt.HEAT]:"#ff8100",[gt.COOL]:"#2b9af9",[gt.AUTO]:"#4caf50",[gt.HEAT_COOL]:"#4caf50",[gt.DRY]:"#efbd07",[gt.FAN_ONLY]:"#8a8a8a",[gt.OFF]:"#8a8a8a"};function $t(t,e){return e?.[t]??_t[t]??"#8a8a8a"}function vt(t){const e=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(t);return e?`${parseInt(e[1],16)}, ${parseInt(e[2],16)}, ${parseInt(e[3],16)}`:"138, 138, 138"}mt.HEATING,mt.COOLING,mt.DRYING,mt.IDLE,mt.FAN,mt.OFF;const yt={[gt.OFF]:"mdi:power",[gt.HEAT]:"mdi:fire",[gt.COOL]:"mdi:snowflake",[gt.HEAT_COOL]:"mdi:autorenew",[gt.AUTO]:"mdi:autorenew",[gt.DRY]:"mdi:water-percent",[gt.FAN_ONLY]:"mdi:fan"};mt.HEATING,mt.COOLING,mt.DRYING,mt.IDLE,mt.FAN,mt.OFF;const bt={auto:"mdi:fan-auto",low:"mdi:fan-speed-1",medium:"mdi:fan-speed-2","medium-low":"mdi:fan-speed-1","medium-high":"mdi:fan-speed-2",high:"mdi:fan-speed-3",on:"mdi:fan",off:"mdi:fan-off",diffuse:"mdi:weather-windy"},wt={on:"mdi:arrow-oscillating",off:"mdi:arrow-oscillating-off",both:"mdi:arrow-oscillating",vertical:"mdi:arrow-up-down",horizontal:"mdi:arrow-left-right"},xt={none:"mdi:cancel",home:"mdi:home",away:"mdi:account-arrow-right",boost:"mdi:rocket-launch",comfort:"mdi:sofa",eco:"mdi:leaf",sleep:"mdi:bed",activity:"mdi:motion-sensor"};function At(t){return yt[t]??"mdi:thermostat"}function Ct(t,e=1,i="N/A"){return null==t||isNaN(t)?i:Number(t).toFixed(e)}function Et(t,e,i,o){const s=new CustomEvent(e,{bubbles:!0,composed:!0,cancelable:!1,detail:i});t.dispatchEvent(s)}function St(t,e="light"){Et(t,"haptic",e)}function Tt(t,e){Et(t,"hass-more-info",{entityId:e})}const kt={hvac:{type:"hvac",attributeModes:"hvac_modes",attributeActive:"__state__",headingKey:"card.hvac_modes",getIcon:At,getColor:$t},fan:{type:"fan",attributeModes:"fan_modes",attributeActive:"fan_mode",headingKey:"card.fan_modes",getIcon:function(t){return bt[t.toLowerCase()]??"mdi:fan"},getColor:(t,e)=>e?.fan??"var(--primary-color)"},preset:{type:"preset",attributeModes:"preset_modes",attributeActive:"preset_mode",headingKey:"card.preset_modes",getIcon:function(t){return xt[t.toLowerCase()]??"mdi:tune"},getColor:(t,e)=>e?.preset??"#b39ddb"},swing:{type:"swing",attributeModes:"swing_modes",attributeActive:"swing_mode",headingKey:"card.swing_modes",getIcon:function(t){return wt[t.toLowerCase()]??"mdi:arrow-oscillating"},getColor:(t,e)=>e?.swing??"#ffb74d"}},Ot=["off","heat","cool","heat_cool","auto","dry","fan_only"];function Mt(t,e,i,o,s){if(!1===o)return G;const n=t.language??"en",r=[];for(const a of["hvac","fan","preset","swing"]){const c=o[a];if(!1===c||void 0===c)continue;const d=kt[a],l="hvac"===a?i.layout?.hvac??i.layout?.mode:i.layout?.[a],h=Pt(t,e,i,d,c,n,!1!==l?.names,!1!==l?.icons,!0===l?.headings,t=>s(a,t));h!==G&&r.push(h)}return 0===r.length?G:V`${r}`}function Pt(t,e,i,o,s,n,r,a,c,d){const l=e.attributes[o.attributeModes]??[];if(0===l.length)return G;if(("object"==typeof s&&void 0!==s._hide_when_off?s._hide_when_off:"hvac"!==o.type)&&("off"===e.state||"unavailable"===e.state))return G;const h="__state__"===o.attributeActive?e.state:e.attributes[o.attributeActive]??"",p="object"==typeof s&&s._name?s._name:ft(o.headingKey,n);let u;const f="object"==typeof s&&Object.keys(s).some(t=>!t.startsWith("_"));if(f){const t=Object.keys(s).filter(t=>!t.startsWith("_")),e=t.filter(t=>l.includes(t)),i=l.filter(e=>!t.includes(e));u=[...e,...i]}else u=[...l],"hvac"===o.type&&u.sort((t,e)=>(-1!==Ot.indexOf(t)?Ot.indexOf(t):99)-(-1!==Ot.indexOf(e)?Ot.indexOf(e):99));const g=[];for(const t of u){let e;if("object"==typeof s){const i=s[t];if(!1===i||"object"==typeof i&&!1===i?.include)continue;"object"==typeof i&&(e=i)}const r=void 0!==e?.name&&!1!==e.name?e.name:ft(`mode.${t}`,n)!==`mode.${t}`?ft(`mode.${t}`,n):t.replace(/_/g," "),a=void 0!==e?.icon&&!1!==e.icon?e.icon:o.getIcon(t),c=o.getColor(t,i.colors);g.push({value:t,name:r,icon:a,color:c})}return 0===g.length?G:V`
  ...
  `}function Nt(t,e,i,o){if(!1===o.sensors||!o.sensors||0===o.sensors.length)return G;const s=o.layout?.sensors??{},n="table"===s.type,r=!1!==s.labels,a=o.sensors.map(o=>function(t,e,i,o,s){const n=o.entity??i.entity_id,r=e.states[n];if(!r)return G;let a,c;if(o.attribute)a=r.attributes[o.attribute];else{if(!o.entity)return G;a=r.state}if(null==a)return G;if("relativetime"===o.type){c=function(t){const e=Date.now(),i=Math.floor((e-t.getTime())/1e3);return i<60?`${i}s`:i<3600?`${Math.floor(i/60)}m`:i<86400?`${Math.floor(i/3600)}h`:`${Math.floor(i/86400)}d`}(new Date(a))}else c=void 0!==o.decimals&&"number"==typeof a?Ct(a,o.decimals):String(a);const d=o.unit??(o.attribute?"":r.attributes.unit_of_measurement??""),l=o.name??(o.attribute?o.attribute.replace(/_/g," "):r.attributes.friendly_name??n);return V`
    <div
      class="sensor-item"
      @click=${()=>Tt(t,n)}
    >
      ${o.icon?V`<ha-icon .icon=${o.icon}></ha-icon>`:G}
      ${s&&!o.icon?V`<span class="sensor-label">${l}:</span>`:G}
