        ...
        <ha-card>
          ...
          ${this._expanded?V`
                <div class="expand-section">
                  ...
                  ${!0!==this._config.hide?.state?kt(this,this._hass,t,this._config):W}
                </div>
              `:W}
        </ha-card>
      ...
      <div class="compact">
        ...
        >
          ...
          <div class="info">
            ...
            <div class="secondary">
              ${h}
              ${g.length>0?V` <span class="stats">\u00b7 ${g.join(" · ")}</span>`:W}
            </div>
          </div>
        </div>
        ${a||void 0===_?W:V`
